...
class GRUDecoderState:
    ...
    def __init__(self, hidden_size, hidden_state):
        ...
        """
        self.hidden_size = hidden_size
        self.hidden_state = hidden_state  # (layers, batch_size, hidden_size)
    ...
    def repeat_beam_size_times(self, beam_size):
        ...
        self.hidden_state = self.hidden_state.repeat(1, beam_size, 1)
        self.input_feed = self.input_feed.repeat(1, beam_size, 1)
    #
    # def detach(self):
